...
const TermsScreen = ({ navigation }) => {
  ...
  const sections = [
    ...
    { title: t('terms.usersTitle'), text: t('terms.usersText') },
    { title: t('terms.contentTitle'), text: t('terms.contentText') },
    { title: t('terms.liabilityTitle'), text: t('terms.liabilityText') },
  ];

  return (
    <ScreenLayout title={t('terms.title')} showBack onBack={() => navigation.goBack()}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={[styles.card, { backgroundColor: colors.surface }]}>
          <Text style={[styles.effective, { color: colors.text.secondary }]}>{t('terms.effective')}</Text>
          <Text style={[styles.intro, { color: colors.text.secondary }]}>{t('terms.intro')}</Text>
        </View>
        ...
        <View style={[styles.card, { backgroundColor: colors.surface }]}>
          <Text style={[styles.sectionText, { color: colors.text.secondary }]}>{t('terms.contact')}</Text>
        </View>
      </ScrollView>
    </ScreenLayout>
  );
