...
const GIVEN_NAMES = [
  'Батбаяр', 'Ганбаатар', 'Мөнхбат', 'Түвшинбаяр', 'Энхбат', 'Батсайхан', 'Отгонбаяр',
  'Наранбаатар', 'Ганзориг', 'Эрдэнэбат', 'Хүрэлбаатар', 'Пүрэвсүрэн', 'Амарсайхан',
  'Батмөнх', 'Гантулга', 'Даваасүрэн', 'Түмэнбаяр', 'Ганхуяг', 'Батжаргал', 'Мөнхөрхөн',
  'Оюунчимэг', 'Цэцэгмаа', 'Наранцэцэг', 'Алтанцэцэг', 'Болормаа', 'Энхтуяа', 'Ганчимэг',
  'Сарантуяа', 'Мөнгөнцэцэг', 'Уранчимэг', 'Дэлгэрмаа', 'Отгонцэцэг', 'Эрдэнэчимэг',
  'Ариунзаяа', 'Хишигдэлгэр', 'Нарангэрэл', 'Золжаргал', 'Тэмүүлэн', 'Ням-Осор', 'Бат-Эрдэнэ',
];

/** Father's names — the `parent_name` column, shown first in Mongolian usage. */
const PARENT_NAMES = [
  'Дорж', 'Лхагва', 'Цэрэн', 'Жаргал', 'Дашням', 'Пүрэвдорж', 'Нацагдорж', 'Гомбо',
  'Чулуун', 'Мягмар', 'Даваа', 'Ням', 'Ширчин', 'Балдан', 'Сүхбат', 'Ганбат', 'Батаа',
  'Дамдин', 'Түмэн', 'Очир', 'Загдсүрэн', 'Баттөмөр', 'Ундрах', 'Сандаг',
];
...
const latin = (mn: string) => mn.toLowerCase().split('').map((c) => TRANSLIT[c] ?? '').join('');

/** Mobile prefixes actually issued in Mongolia (Unitel/Mobicom/Skytel/G-Mobile). */
const MOBILE_PREFIXES = ['99', '95', '94', '91', '90', '89', '88', '86', '85', '80'];
const mobile = () => `${pick(MOBILE_PREFIXES)}${String(int(100000, 999999))}`;

const COMPANIES = [
  { name: 'Мон Констракшн ХХК', trade: 'monconstruction', about: 'Иргэний болон үйлдвэрийн барилгын ерөнхий гүйцэтгэгч. 2008 оноос хойш 60 гаруй обьект ашиглалтад оруулсан.' },
  { name: 'Гоби Билдинг ХХК', trade: 'gobibuilding', about: 'Өмнөговь, Дорноговь аймагт уул уурхайн дэд бүтэц, кемпийн барилга угсралт хийдэг.' },
  { name: 'Хөх Тэнгэр Групп ХХК', trade: 'khukhtenger', about: 'Барилгын материалын худалдаа, ложистик. Хөтөл, Эрдэнэт чиглэлийн тогтмол хүргэлттэй.' },
  { name: 'Ундрам Трейд ХХК', trade: 'undramtrade', about: 'Барилгын тусгай зориулалтын техник түрээс, засвар үйлчилгээ.' },
  { name: 'Ар Билэг ХХК', trade: 'arbileg', about: 'Дотор гадна засал чимэглэл, гипсэн ажил, будаг. Улаанбаатар хотод үйл ажиллагаа явуулдаг.' },
  { name: 'Эрчим Инженеринг ХХК', trade: 'erchimengineering', about: 'Цахилгаан, дулаан, салхивчийн угсралт болон зураг төслийн үйлчилгээ.' },
  { name: 'Тэгш Талбай ХХК', trade: 'tegshtalbai', about: 'Геодезийн хэмжилт, хөрсний шинжилгээ, барилгын ажлын зураг.' },
  { name: 'Наран Бетон ХХК', trade: 'naranbeton', about: 'Бэлэн бетон, бетон блок үйлдвэрлэл. Өдөрт 400 м3 хүчин чадалтай.' },
  { name: 'Хүлэг Транс ХХК', trade: 'khulegtrans', about: 'Хүнд даацын тээвэр, самосвал, крантай үйлчилгээ улс даяар.' },
  { name: 'Идэр Металл ХХК', trade: 'idermetall', about: 'Металл хийц, хаалга цонх, ангар барилгын үйлдвэрлэл.' },
  { name: 'Цаст Уул Сервис ХХК', trade: 'tsastuulservice', about: 'Өвлийн үйлчилгээ: цас цэвэрлэгээ, хөрс гэсгээх, халаагуур түрээс.' },
  { name: 'Батсүмбэр Констракшн ХХК', trade: 'batsumber', about: 'Төв аймаг, Улаанбаатарын захын бүсэд суурь, доторх ажил гүйцэтгэдэг.' },
];
...
const PLACES: Record<string, { lat: number; lng: number; areas: string[] }> = {
  ...
  ORKHON: { lat: 49.0275, lng: 104.0444, areas: ['Эрдэнэт хот, Уртбулаг баг', 'Эрдэнэт хот, Найрамдал баг', 'Эрдэнэт хот, Говил хороолол'] },
  DARKHANUUL: { lat: 49.4867, lng: 105.9228, areas: ['Дархан хот, 8-р баг', 'Дархан хот, Өргөө хороолол', 'Хонгор сум, Дархан-Уул'] },
  SELENGE: { lat: 50.2394, lng: 106.2075, areas: ['Сүхбаатар хот, 3-р баг', 'Мандал сум, Зүүнхараа', 'Сайхан сум, Сэлэнгэ'] },
  UMNUGOVI: { lat: 43.5708, lng: 104.4250, areas: ['Даланзадгад сум, Өмнөговь', 'Ханбогд сум, Оюу толгойн бүс', 'Цогтцэций сум, Тавантолгой'] },
  DORNOGOVI: { lat: 44.8917, lng: 110.1394, areas: ['Сайншанд сум, 2-р баг', 'Замын-Үүд сум, чөлөөт бүс', 'Айраг сум, Дорноговь'] },
  TUV: { lat: 47.7050, lng: 106.8900, areas: ['Зуунмод сум, Төв аймаг', 'Батсүмбэр сум, Төв аймаг', 'Сэргэлэн сум, Хөшигийн хөндий'] },
  KHUVSGUL: { lat: 49.6342, lng: 100.1625, areas: ['Мөрөн сум, 5-р баг', 'Хатгал тосгон, Хөвсгөл'] },
};
/**
...
const UB_AREAS: Record<string, string[]> = {
  ...
  BAYANGOL: ['3-р хороолол', '10-р хороолол', 'Тахилын шат', 'Баруун дөрвөн зам'],
...
const UB_KHOROOS: Record<string, number> = {
  BAYANZURKH: 43, SONGINOKHAIRKHAN: 43, BAYANGOL: 34, KHANUUL: 25,
  CHINGELTEI: 24, SUKHBAATAR: 20, NALAIKH: 8,
};
...
function addressFor(province: string, district: string | null): string {
  if (province === 'ULAANBAATAR') {
    ...
    const dn: Record<string, string> = {
      BAYANZURKH: 'Баянзүрх', KHANUUL: 'Хан-Уул', BAYANGOL: 'Баянгол', SUKHBAATAR: 'Сүхбаатар',
      CHINGELTEI: 'Чингэлтэй', SONGINOKHAIRKHAN: 'Сонгинохайрхан', NALAIKH: 'Налайх',
    };
...
const CATALOG: Record<string, Catalog> = {
  vehiclerent: {
    brands: {
      Toyota: ['Land Cruiser 200', 'Land Cruiser Prado 150', 'Hiace', 'Coaster', 'Hilux'],
    ...
    subModels: {
      car: ['Toyota Prius 30', 'Toyota Camry 40', 'Hyundai Sonata', 'Nissan Teana'],
      suv: ['Toyota Land Cruiser 200', 'Toyota Land Cruiser Prado 150', 'Nissan Patrol Y61', 'Mitsubishi Pajero'],
      truck: ['Hyundai Porter II', 'Mitsubishi Canter', 'Isuzu Elf', 'Toyota Dyna'],
      bus: ['Hyundai County', 'Toyota Coaster', 'Hyundai Universe', 'Daewoo BS106'],
      van: ['Toyota Hiace', 'Hyundai Starex', 'Mitsubishi Delica', 'Ford Transit'],
    },
    titles: {
      car: ['{bm} суудлын машин хоногоор түрээслүүлнэ', 'Хотын дотор явах {bm} түрээслүүлнэ'],
      suv: ['{bm} жийп жолоочтой түрээслүүлнэ', 'Хээрийн ажилд {bm} — жолоочтой, шатахуунгүй үнэ'],
      truck: ['{bm} ачааны машин түрээслүүлнэ', '{bm} — 3 тн ачаа, хот орон нутаг'],
      bus: ['{bm} автобус — хамт олны аялал, ээлжийн тээвэрт', '{bm} 35 суудалтай автобус захиалгаар'],
      van: ['{bm} микроавтобус — ажилчид зөөх, 14 суудал', '{bm} микро түрээслүүлнэ, жолоочтой'],
    },
    details: [
  ...
  machineryrent: {
    ...
    subModels: {
      ...
      excavator: ['Komatsu PC200-8', 'Caterpillar 320D', 'Hitachi ZX200-3', 'Hyundai R220LC-9S', 'Doosan DX225LCA', 'Sany SY215C'],
      bulldozer: ['Komatsu D65EX-15', 'Caterpillar D6R', 'Shantui SD16'],
      loader: ['Komatsu WA380-6', 'Caterpillar 950H', 'Hyundai HL760-9', 'XCMG LW300FN'],
    ...
    titles: {
      crane: ['{bm} 25 тн кран операторчтой түрээслүүлнэ', 'Автокран {bm} — өргөх ажил гүйцэтгэнэ'],
      excavator: ['{bm} экскаватор операторчтой түрээслүүлнэ', '{bm} — суурийн ухалт, шороон ажил'],
      bulldozer: ['{bm} бульдозер түрээслүүлнэ', 'Талбай тэгшлэх {bm} бульдозер, мото цагаар'],
      loader: ['{bm} дугуйт ачигч түрээслүүлнэ', '{bm} ачигч — хайрга, элс ачилт'],
      compactor: ['{bm} нягтруулагч, зам талбайн ажилд', 'Виброкаток {bm} түрээслүүлнэ'],
      forklift: ['{bm} сэрээт өргөгч 3 тн — агуулахын ажилд', 'Форклифт {bm} өдрөөр түрээслүүлнэ'],
      grader: ['{bm} автогрейдер — зам засвар, тэгшилгээ', 'Грейдер {bm} мото цагаар'],
      concrete_mixer: ['Бетон зуурагч {bm} — 6 м3 миксер', 'Бетон зөөвөрлөх миксер машин түрээслүүлнэ'],
      drilling_rig: ['{bm} өрөмдлөгийн төхөөрөмж, свайны ажилд', 'Хөрс өрөмдөх төхөөрөмж — операторчтой'],
    },
    details: [
  ...
  toolrent: {
    ...
    subModels: {
      power_tools: ['Bosch GBH 2-26', 'Makita HR2470', 'DeWalt D25133K', 'Hilti TE 60-ATC'],
      measuring: ['Leica Rugby 620', 'Bosch GLL 3-80', 'Topcon RL-H5A', 'Sokkia B40'],
    },
    titles: {
      power_tools: ['{bm} перфоратор өдрөөр түрээслүүлнэ', 'Цахилгаан багаж түрээс — {bm} багц'],
      formwork: ['Баганы болон хананы хэв түрээслүүлнэ', 'Дам нурууны хэв, тулгуур — м2-оор'],
      scaffolding: ['Барилгын шат (леса) түрээслүүлнэ, м2-оор', 'Хүрээт шат — өргөлт 12 м хүртэл'],
      measuring: ['Лазер нивелир {bm} түрээслүүлнэ', 'Теодолит, нивелир — хоногоор'],
    },
    details: [
  ...
  materialstore: {
    titles: {
      cement: ['Хөтөл цемент М400 — тонноор нийлүүлнэ', 'Портланд цемент, шуудайгаар ба задгайгаар'],
      aggregate: ['Хайрга, элс — самосвалаар хүргэнэ', 'Угаасан элс, 5-20 фракцын хайрга'],
      rebar: ['Арматур 12, 14, 16 мм — тонноор', 'Хар төмөр, профиль хоолой худалдана'],
      timber: ['Сибирийн нарсан банз, дүнз', 'Модон материал — 25, 40, 50 мм зузаантай'],
      insulation: ['Хөөсөнцөр, шилэн хөвөн дулаалга', 'Пеноплекс 50 мм — м2-оор'],
      brick_block: ['Улаан тоосго, хөнгөн блок нийлүүлнэ', 'Керамзит блок 390х190х190'],
      roofing: ['Дээврийн модон хийц, зэвэрдэггүй бүрхүүл', 'Профиль хуудас, ондулин дээвэр'],
      finishing: ['Гипсэн хавтан, шпаклёвк, будаг', 'Заслын материал — бөөний үнээр'],
      plumbing_electrical: ['Сантехникийн хоолой, фитинг', 'Цахилгааны кабель, автомат таслуур'],
      other: ['Барилгын туслах материал, хэрэгсэл', 'Холбогч материал, өнгөлгөө'],
    },
    details: [
  ...
  construction: {
    titles: {
      general: ['Барилгын ерөнхий гүйцэтгэгч — түлхүүр гардуулах', 'Суурь, каркас, ханын ажил гүйцэтгэнэ'],
      interior: ['Дотор засал — гипсэн хана, таазны ажил', 'Орон сууцны бүрэн засвар, материалтай'],
      exterior: ['Гадна фасадны ажил, дулаалга', 'Гадна засал — өнгөлгөө, шавардлага'],
      electrical: ['Цахилгааны угсралт, суурилуулалт', 'Цахилгааны шугам сүлжээ, самбарын ажил'],
      plumbing: ['Сантехникийн угсралт, халаалтын шугам', 'Ус, дулаан, ариутгах татуургын ажил'],
      roofing: ['Дээврийн ажил — модон хийц, бүрхүүл', 'Дээвэр засвар, ус тусгаарлалт'],
      flooring: ['Шалны ажил — ламинат, паркет, плита', 'Өөрөө тэгшрэх шал, наливной'],
  ...
  jobvacancy: {
    titles: {
      engineer: ['Барилгын инженер авна', 'Технологич инженер — уул уурхайн төсөлд'],
      worker: ['Барилгын ажилчин авна (байр, хоолтой)', 'Туслах ажилчид яаралтай авна'],
      driver: ['Экскаваторын оператор авна — ээлжийн ажил', 'Самосвалын жолооч авна, С ангилал'],
      welder: ['Гагнуурчин авна — аргон, хагас автомат', 'Туршлагатай гагнуурчин, хийцийн ажилд'],
      electrician: ['Цахилгаанчин авна, 3-р зэрэгтэй', 'Цахилгааны угсралтын ажилтан авна'],
      plumber: ['Сантехникч авна — халаалтын угсралт', 'Сантехникийн туслах ажилтан авна'],
      manager: ['Обьектын менежер авна', 'Ханган нийлүүлэлтийн менежер авна'],
      accountant: ['Нягтлан бодогч авна (барилгын салбар)', 'Ахлах нягтлан бодогч авна'],
    },
    details: [
  ...
  factory: {
    titles: {
      concrete: ['Бэлэн бетон М200–М400 үйлдвэрлэл', 'Бетон блок, хашлага үйлдвэрлэнэ'],
      metal: ['Металл хийц, ферм үйлдвэрлэл', 'Ангар барилгын каркас захиалгаар'],
      wood: ['Модон эдлэл, шат, хаалга үйлдвэрлэл', 'Мебель, интерьерийн модон хийц'],
      brick: ['Улаан тоосго үйлдвэрлэл — өдөрт 20,000 ш', 'Хөнгөн блок, керамзит блок'],
      glass: ['Шилэн хийц, витраж үйлдвэрлэл', 'Хатуулагдсан шил, толь захиалгаар'],
      door_window: ['ПВЦ цонх, хаалга захиалгаар', 'Төмөр хаалга, орцны хаалга үйлдвэрлэл'],
    },
    details: [
  ...
  sos: {
    titles: {
      tire_repair: ['Дуудлагын дугуй засвар — 24 цаг', 'Хээрийн дугуй засвар, ачааны машины дугуй'],
      towing: ['Эвакуатор — чирэх үйлчилгээ 24/7', 'Ачааны машин чирэх, трал үйлчилгээ'],
      battery: ['Аккумулятор солих, цэнэглэх дуудлага', 'Хээрийн аккумуляторын үйлчилгээ'],
      fuel_delivery: ['Шатахуун хүргэлт — дизель, А92', 'Хээрийн шатахуун хүргэлт, 24 цаг'],
      mobile_repair: ['Дуудлагын авто засвар, хөдөлгүүрийн оношилгоо', 'Замд гэмтсэн техникийн засвар'],
      jump_start: ['Асаалт өгөх үйлчилгээ — хот, орон нутаг', 'Хүйтэнд асаахад тусална, 24 цаг'],
    },
    details: [
  ...
  usedequipment: {
    ...
    subModels: {
      vehicle: ['Toyota Land Cruiser 105', 'Toyota Hiace', 'Hyundai Porter II', 'Howo ZZ3257', 'Shacman F3000'],
      machinery: ['Komatsu PC200-8', 'Caterpillar 320C', 'Hyundai R220LC-9S', 'Komatsu WA320-5', 'Caterpillar 140G'],
    },
    titles: {
      vehicle: ['{bm} зарна — гүйлт бага, бүрэн бүтэн', '{bm} худалдана, үнэ тохирно'],
      machinery: ['{bm} экскаватор зарна', '{bm} — мото цаг бага, ажлын байдалтай'],
      tools: ['Барилгын багаж хэрэгсэл бөөнөөр зарна', 'Гагнуурын аппарат, компрессор зарна'],
      spare_parts: ['Экскаваторын сэлбэг зарна', 'Хүнд машины сэлбэг — гинж, хувин, шүд'],
    },
    details: [
  ...
  transport: {
    titles: {
      freight: ['Ачаа тээвэр — хот, орон нутаг', 'Бүх төрлийн ачаа тээвэрлэнэ, гэрээгээр'],
      dump_truck: ['Самосвал 20 тн — хайрга, элс, шороо', 'Самосвалаар шороо зөөнө, өдрөөр'],
      crane_service: ['Крантай машин — 10 тн өргөнө', 'Крантай үйлчилгээ, ачилт буулгалт'],
      heavy_haul: ['Трал — хүнд даацын техник тээвэрлэнэ', 'Хүнд даацын тээвэр, зөвшөөрөлтэй'],
      water_delivery: ['Ус хүргэлт — 8 м3 цистерн', 'Барилгын талбайд ус хүргэнэ'],
    },
    details: [
  ...
  designservice: {
    titles: {
      architecture: ['Архитектур зураг төсөл боловсруулна', 'Амины орон сууцны зураг төсөл'],
      structural: ['Бүтээцийн тооцоо, ажлын зураг', 'Төмөр бетон бүтээцийн зураг төсөл'],
      surveying: ['Геодезийн хэмжилт, топо зураг', 'Барилгын тэнхлэг тавих, гүйцэтгэлийн зураг'],
      soil_testing: ['Хөрсний шинжилгээ, инженер геологи', 'Суурийн хөрсний судалгаа, дүгнэлт'],
      permits: ['Барилгын зөвшөөрөл, баримт бичиг бүрдүүлнэ', 'Ашиглалтад оруулах комисс, бичиг баримт'],
      interior_design: ['Интерьер дизайн, 3D визуализаци', 'Орон сууцны интерьер зураг төсөл'],
    },
    details: [
  ...
  miningsupport: {
    titles: {
      drilling_blasting: ['Өрөмдлөг, тэсэлгээний ажил гүйцэтгэнэ', 'Тэсэлгээний үйлчилгээ — зөвшөөрөлтэй'],
      earthworks: ['Уурхайн шороон ажил — өөрийн техниктэй', 'Хуулалт, овоолго, тэгшилгээний ажил'],
      haulage: ['Уурхайн дотоод тээвэр, хүдэр зөөвөрлөлт', 'Хүдэр, хаягдал чулуу тээвэрлэнэ'],
      camp_services: ['Кемпийн үйлчилгээ — байр, хоол, цэвэрлэгээ', 'Ажилчдын кемп ажиллуулна'],
      maintenance: ['Хүнд машин механизмын засвар үйлчилгээ', 'Хээрийн засварын баг — уурхайн техник'],
    },
    details: [
  ...
  winterservice: {
    titles: {
      snow_removal: ['Цас цэвэрлэгээ — гэрээгээр, техниктэй', 'Байгууллагын талбайн цас цэвэрлэнэ'],
      ground_thawing: ['Хөрс гэсгээх үйлчилгээ — цахилгаан халаагуур', 'Өвлийн ухалтад хөрс гэсгээнэ'],
      heating_rental: ['Дизель халаагуур түрээслүүлнэ', 'Барилгын халаагуур, тепловой пушка'],
      winterization: ['Өвөлжилтийн бэлтгэл — шугам хоолойн дулаалга', 'Талбайн өвөлжилтийн бэлтгэл ажил'],
    },
    details: [
 ...
 */
async function makeImage(dir: string, name: string, hex: string, label: string, w = 1200, h = 900) {
...
async function seedImageFiles(): Promise<Record<string, string[]>> {
  ...
  for (const cat of CATEGORY_SEED) {
    ...
    pools[key] = [];
    for (let n = 1; n <= 4; n++) {
      pools[key].push(await makeImage('posts', `seed-${key}-${n}.jpg`, hex, `${label} ${n}`));
    }
  }
...
function valueFor(f: any, i: number, cat: any, ctx: PostCtx): any {
  switch (f.key) {
    case 'manufacturer': return ctx.brand ?? pick(['Bosch', 'Makita', 'XCMG']);
    case 'model': return ctx.model ?? `${pick(['ZM', 'HX', 'TR'])}-${int(100, 900)}`;
    case 'year': return int(2009, 2024);
    case 'capacity':
      return cat.key === 'transport' ? pick([3, 5, 10, 15, 20, 25, 40])
        : cat.key === 'factory' ? int(20, 400) * 50
          : pick([1.5, 5, 12, 20, 25, 50]);
    case 'seats': return ctx.sub === 'bus' ? pick([24, 35, 45]) : ctx.sub === 'van' ? pick([11, 14, 18]) : pick([4, 5, 7]);
    case 'fuel_type': return ctx.sub === 'car' ? pick(['PETROL', 'GAS', 'ELECTRIC']) : pick(['DIESEL', 'DIESEL', 'PETROL']);
    case 'experience_years': return int(2, 25);
    case 'team_size': return int(4, 30);
    case 'crew_size': return int(6, 45);
    case 'positions': return int(1, 12);
    case 'vehicle_count': return int(1, 14);
    case 'quantity_available': return int(2, 60);
    case 'min_rental_days': return pick([1, 3, 5, 7]);
    case 'min_moto_hours_per_day': return pick([6, 8, 10, 12]);
    case 'warranty_months': return pick([6, 12, 24, 36]);
    case 'delivery_days': return pick([7, 10, 14, 21, 30, 45]);
    case 'project_count': return int(4, 140);
    case 'response_time_min': return pick([15, 20, 30, 45, 60, 90]);
    case 'mileage_km': return int(30, 420) * 1000;
    case 'moto_hours': return int(800, 14000);
    // "БА" for барилга, the shape the licence actually takes on a permit.
    case 'license_no': return `${pick(['БА', 'ГА', 'УУ'])}-${int(2016, 2025)}/${int(100, 4999)}`;
    case 'min_order':
      return cat.key === 'factory' ? pick(['50 ш', '100 ш', '500 ш', '1 багц'])
        : pick(['1 тонн', '5 тонн', '1 машин', '10 шуудай', '20 м2']);
    case 'salary_min': return int(12, 30) * 100_000;
    case 'salary_max': return 0;   // rewritten below, once salary_min is known
    default:
      break;
  }
  switch (f.type) {
...
const BRAND_HEXES = CATEGORY_SEED.map((c: any) => c.color as string).filter(Boolean);
...
async function seedCompanies(client: Client) {
  ...
  for (let i = 0; i < COMPANIES.length; i++) {
    ...
    const logo = i < 10
      ? await makeImage('companylogo', `seed-logo-${i + 1}.jpg`, BRAND_HEXES[i % BRAND_HEXES.length],
        c.name.replace(' ХХК', ''), 512, 512)
      : null;
    const { rows: [row] } = await client.query(
      ...
      [
        c.name, c.about, addressFor(province, district),
        // 7xxxxxxx is the landline range a registered company publishes.
        `7${int(0, 9)}${int(100000, 999999)}`,
        `info@${c.trade}.mn`, reg, reg ? `${reg}` : `${int(2000000, 6999999)}`, verified,
        logo, i % 4 === 3 ? null : `www.${c.trade}.mn`,
      ],
    );
    rows.push(row.id);
  }
  console.log(`companies: ${rows.length} named firms (${rows.filter((_, i) => i % 3 === 0).length} verified, 1 verified without a reg number)`);
  return rows;
}
...
async function seedUsers(client: Client, companies: string[]) {
  ...
  for (let i = 0; i < 24; i++) {
    ...
    const email = i % 5 === 0 ? null : `${latin(parent).slice(0, 3)}.${latin(given)}@${pick(['gmail.com', 'yahoo.com', 'mail.mn'])}`;
    const province = pick(PROVINCES);
    const district = province === 'ULAANBAATAR' ? pick(UB_DISTRICTS) : null;

    // Two thirds carry a photo; the rest exercise the initials avatar.
    const avatar = i % 3 !== 2
      ? await makeImage('profilepicture', `seed-avatar-p${i + 1}.jpg`,
        BRAND_HEXES[i % BRAND_HEXES.length], given.slice(0, 1), 400, 400)
      : null;
    const { rows: [u] } = await client.query(
  ...
  for (let i = 0; i < 40; i++) {
    ...
    const avatar = i % 4 === 0
      ? await makeImage('profilepicture', `seed-avatar-c${i + 1}.jpg`,
        BRAND_HEXES[(i * 3) % BRAND_HEXES.length], given.slice(0, 1), 400, 400)
      : null;
    const { rows: [u] } = await client.query(
      ...
      [
        uniquePhone(), given, parent,
        i % 3 === 0 ? null : `${latin(given)}${int(70, 99)}@${pick(['gmail.com', 'yahoo.com'])}`,
        avatar,
      ],
    );
    customers.push(u.id);
...
function priceFor(catKey: string): number {
  ...
  const step = raw > 10_000_000 ? 1_000_000 : raw > 1_000_000 ? 100_000 : raw > 100_000 ? 10_000 : 500;
  return Math.max(step, Math.round(raw / step) * step);
}

async function seedPosts(client: Client, owners: Owner[], imagePool: Record<string, string[]>) {
  const ids: number[] = [];
  let lifecycleIdx = 0;
  ...
  for (const cat of CATEGORY_SEED) {
    ...
    for (let i = 0; i < LIFECYCLES.length; i++) {
      ...
      if (attributes.salary_min !== undefined && attributes.salary_max !== undefined) {
        attributes.salary_max = attributes.salary_min + int(2, 12) * 100_000;
      }

      const titleTpl = pick(catalog?.titles?.[sub ?? ''] ?? catalog?.titles?.[Object.keys(catalog?.titles ?? {})[0]] ?? ['{bm}']);
      const title = titleTpl.replace('{bm}', `${brand ?? ''} ${model ?? ''}`.trim()).replace(/\s+/g, ' ').trim();
      ...
      const details = `${pick(catalog?.details ?? ['Дэлгэрэнгүй мэдээллийг утсаар авна уу.'])}`
        + ` Байршил: ${address}.`
...
async function seedEngagement(client: Client, postIds: number[], customers: string[]) {
  ...
  await client.query(`UPDATE post SET views = id % 9 WHERE id NOT IN (SELECT post_id FROM viewedpost)`);
  console.log(`engagement: ${likes} likes, ${views} recorded views (post.views reconciled with the log)`);
}
...
async function seedSavedSearches(client: Client, customers: string[]) {
  const searches = [
    { name: 'Экскаватор — УБ', category: 'machineryrent', subcategory: 'excavator', province: 'ULAANBAATAR', q: null, attrs: { with_operator: true } },
    { name: 'Кран түрээс', category: 'machineryrent', subcategory: 'crane', province: null, q: 'кран', attrs: {} },
    { name: 'Цемент бөөний', category: 'materialstore', subcategory: 'cement', province: 'ULAANBAATAR', q: 'цемент', attrs: { sale_type: 'WHOLESALE' } },
    { name: 'Жолоочийн ажил', category: 'jobvacancy', subcategory: 'driver', province: null, q: null, attrs: { accommodation_provided: true } },
    { name: 'Самосвал — Өмнөговь', category: 'transport', subcategory: 'dump_truck', province: 'UMNUGOVI', q: null, attrs: {} },
    { name: 'Дотор засал', category: 'construction', subcategory: 'interior', province: 'ULAANBAATAR', q: 'засал', attrs: { with_materials: true } },
    { name: 'Хямд жийп', category: 'vehiclerent', subcategory: 'suv', province: 'ULAANBAATAR', q: null, attrs: {} },
    { name: 'Хуучин техник', category: 'usedequipment', subcategory: 'machinery', province: null, q: 'экскаватор', attrs: { condition: 'GOOD' } },
  ];
  let made = 0;
  for (let i = 0; i < 18; i++) {
    ...
    await client.query(
      ...
      [user, s.name, s.category, s.subcategory, s.province, s.q, JSON.stringify(s.attrs)],
    );
    made++;
  }
  console.log(`saved searches: ${made} across ${new Set(Array.from({ length: 18 }, (_, i) => customers[i % customers.length])).size} customers (a third already notified once)`);
}
...
async function seedBookings(client: Client, customers: string[]) {
  ...
  const RESPONSE_HOURS: Record<string, number | null> = {
    PENDING: null, EXPIRED: null, CANCELLED: null,
    ACCEPTED: 3, DECLINED: 9,
  };
  ...
  for (let i = 0; i < posts.length; i++) {
    ...
    const respondedAt = respHours == null
      ? 'NULL'
...
async function seedAuthArtifacts(client: Client, users: { id: string; phone: string }[]) {
  ...
  for (let i = 0; i < 16; i++) {
    ...
    await client.query(
      ...
      [
        `remote-${i + 1}`, users[i % users.length].phone, `ZM${int(1000, 9999)}`, st,
  ...
  for (let i = 0; i < 20; i++) {
    await client.query(
      ...
      [createHash('sha256').update(`trusted-${i}`).digest('hex'), users[i % users.length].id],
    );
  }
  ...
  for (let i = 0; i < 400; i++) {
    ...
    await client.query(
      ...
      [
        name,
        `anon-${int(1, 120)}`,
        pick(['/', '/browse', '/customer/map', '/customer/saved', `/posts/${int(1, 150)}`]),
