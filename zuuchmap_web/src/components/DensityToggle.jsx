...
export default function DensityToggle({ density, onToggle, className = '' }) {
  ...
  return (
    <button
      ...
      className={`inline-flex items-center gap-1.5 min-h-[36px] px-3 py-2 text-xs font-medium border border-border/50 rounded-btn text-muted hover:text-primary-text hover:border-primary/40 transition-colors ${className}`}
    >
