...
export default function DensityToggle({ density, onToggle, className = '' }) {
  ...
  return (
    <button
      ...
      className={`flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium border border-border/50 rounded-btn text-muted hover:text-primary hover:border-primary/40 transition-colors ${className}`}
    >
