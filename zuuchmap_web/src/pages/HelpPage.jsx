  ...
  return (
    <div className="min-h-screen bg-background p-3 md:p-6">
      <div className="max-w-2xl mx-auto">
        <PageHeader title={t('helpSupport.title')} icon={HelpCircle} onBack={() => goBack(navigate, '/')} />
        ...
        <div className="bg-surface border border-border/20 shadow-card rounded-card p-6 md:p-8 mb-6 space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <a href={`mailto:${t('helpSupport.emailAddress')}`} className="text-sm text-text hover:text-primary-text transition-colors">{t('helpSupport.emailAddress')}</a>
            </div>
          </div>
          <div className="flex items-center gap-3">
